    ...
    return BlocConsumer<RegisterCubit, RegisterStates>(
        listener: (context, state)
        {
          if (state is RegisterUserErrorState) {
            showToast(context: context, text: state.error,
            ...
            showToast(context: context,
                colorText: Colors.white,
                colorIcon: Colors.white,
                toastState: ToastStates.SUCCECC, text: 'User Register successfully');
            CacheHelper.saveShared(
                key: "token",
          ...
          if (state is RegisterHospitalErrorState) {
            ...
            showToast(context: context,
                colorText: Colors.white,
                colorIcon: Colors.white,
                toastState: ToastStates.SUCCECC, text: 'Hospital Register successfully');
            CacheHelper.saveShared(
                key: "token",
                value: state.registerModel.token
            ).then((value){
