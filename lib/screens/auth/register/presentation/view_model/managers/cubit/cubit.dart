...
class RegisterCubit extends Cubit<RegisterStates> {
  ...
  Future postRegisterUser({
    ...
    try {
      ...
      print(
          "${registerModel!.data!.email}   sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss");
  ...
  Future postRegisterHospital({
    ...
    try {
      ...
      registerModel = RegisterModel.fromJson(response.data);
      print(
          "${registerModel!.data!.name}   sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss");
